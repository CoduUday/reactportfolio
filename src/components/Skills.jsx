...
import cc from "../assets/cloud-computing.png"
    ...
    return <>
        <div className='flex justify-center items-center gap-5 w-screen'>
            ...
            <div className='my-10 rightside relative bg-[#1e1e20] w-4xl p-8 border border-[#383838] rounded-lg'>
                ...
                <h2 className='mt-3.75 poppins text-3xl font-semibold text-white'>Skills</h2>
                ...
                <div className='flex flex-col items-center justify-center'>
                    <div className='flex flex-col items-center justify-center gap-4 bg-[#232325] w-full p-5 rounded-lg border border-[#383838]'>
                    <img src={webdev} width={70} alt="" />
                    <p className='poppins text-white font-semibold text-xl'>Web Development</p>
                    <div className='flex justify-center items-center gap-5 skill-icon mt-5'>
                        <img width={40} src="https://www.vectorlogo.zone/logos/w3_html5/w3_html5-icon.svg" alt="" />
                        <img width={40} src="https://www.vectorlogo.zone/logos/w3_css/w3_css-icon.svg" alt="" />
                        <img width={40} src="https://www.vectorlogo.zone/logos/javascript/javascript-icon.svg" alt="" />
                        <img width={40} src="https://www.vectorlogo.zone/logos/reactjs/reactjs-icon.svg" alt="" />
                        <img width={40} src="https://www.vectorlogo.zone/logos/tailwindcss/tailwindcss-icon.svg" alt="" />
                        <img width={40} src="https://www.vectorlogo.zone/logos/mongodb/mongodb-icon.svg" alt="" />
                   
                    </div>
                    <div className='poppins text-[#d6d6d6]'>
                        I develop efficient and scalable solutions using JavaScript and Python, supported by a strong foundation in Data Structures, Algorithms, and Object-Oriented Programming. My approach focuses on writing clean, optimized code and solving problems with clarity and precision. I continuously improve my technical skills through regular practice and hands-on projects, aiming to build reliable and high-performance applications.
                    </div>
                </div>
                ...
                <div className='flex flex-col items-center justify-center'>
                    <div className='flex flex-col items-center justify-center gap-4 bg-[#232325] w-full p-5 rounded-lg border border-[#383838]'>
                    <img src={cc} width={65} alt="" />
                    <p className='poppins text-white font-semibold text-xl'>Cloud Computing</p>
                    <div className='flex justify-center items-center gap-5 skill-icon mt-5'>
                        <img width={40} src={aws} alt="" />
                        <img width={40} src="https://cdn.worldvectorlogo.com/logos/aws-vpc-1.svg" alt="" />
                        <img width={27} src="https://cdn.worldvectorlogo.com/logos/aws-iam.svg" alt="" />
                        <img width={40} src="https://cdn.worldvectorlogo.com/logos/aws-elastic-load-balancing.svg" alt="" />
                        <img width={40} src="https://cdn.worldvectorlogo.com/logos/aws-glacier.svg" alt="" />
