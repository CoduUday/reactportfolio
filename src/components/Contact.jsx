...
const Contact = () => {
    return <>
        <div className='flex justify-center items-center gap-5 w-screen'>
            <div className="leftside my-18 bg-[#1e1e20] p-5 border border-[#383838] rounded-lg">
            ...
            <div className='my-10 rightside relative bg-[#1e1e20] w-4xl p-8 border border-[#383838] rounded-lg'>
                ...
                <div className='animation '>
                    <h2 className='mt-3.75 poppins text-3xl font-semibold text-white'>Contact Form</h2>
                    <div className="separation h-1.5 w-10 my-5 rounded-lg bg-[linear-gradient(to_right,hsl(45,100%,72%),hsl(35,100%,68%))]">
                    </div>
                    <div className="form">
                        <form action="">
                            <div className="inputwrapper grid grid-cols-2 gap-8">
                                <input
                                    type="text"
                                    placeholder="Full name"
                                    className="w-full px-4 py-3 bg-[#1e1e20] text-white placeholder:text-gray-400 poppins border border-[#383838] rounded-xl outline-none focus:border-yellow-400 transition-all duration-300"
                                />
                                <input
                                    type="text"
                                    placeholder="Phone"
                            ...
                            <textarea
                                className="mt-8 w-full h-32 px-4 py-3 bg-[#1e1e20] text-white placeholder:text-gray-400 poppins border border-[#383838] rounded-xl outline-none focus:border-yellow-400 transition-all duration-300"
                                placeholder="Your Message"
                            ></textarea>


                        </form>
                        <button className='text-[#FFD66B] bg-[#151313] flex gap-2 p-4 mt-5 ml-auto rounded-lg'  type="submit">
                            <svg width={25} fill='rgb(255, 219, 112)' xmlns="http://www.w3.org/2000/svg" class="ionicon s-ion-icon" viewBox="0 0 512 512"><title>Paper Plane</title><path d="M473 39.05a24 24 0 00-25.5-5.46L47.47 185h-.08a24 24 0 001 45.16l.41.13 137.3 58.63a16 16 0 0015.54-3.59L422 80a7.07 7.07 0 0110 10L226.66 310.26a16 16 0 00-3.59 15.54l58.65 137.38c.06.2.12.38.19.57 3.2 9.27 11.3 15.81 21.09 16.25h1a24.63 24.63 0 0023-15.46L478.39 64.62A24 24 0 00473 39.05z"></path></svg><p className='text-[#FFD66B] poppins'>Send Message</p></button>
                    </div>
                </div>
            </div>
        </div>
