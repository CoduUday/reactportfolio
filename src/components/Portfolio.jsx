...
import em from "../assets/eventmanager.png"
...
const Portfolio = () => {
    return <>
        <div className='flex justify-center items-center gap-5 w-screen '>
            <div className="leftside bg-[#1e1e20] my-[12vh] p-5 border border-[#383838] rounded-lg">
    ...
    <div className="grid-item overflow-hidden rounded-lg">
        <a href="https://github.com/CoduUday/Web-Projects/tree/main/Event%20Manager">
            <img
                className="w-[300px] rounded-lg transition-transform duration-300 hover:scale-110"
                src={em}
            />
        </a>
    </div>
    ...
    <div className="grid-item overflow-hidden rounded-lg">
        <a href="https://github.com/CoduUday/Web-Projects/tree/main/Spotify%20Clone">
            <img
                className="w-[300px] rounded-lg transition-transform duration-300 hover:scale-110"
                src={spotify}
            />
    ...
    <div className="grid-item overflow-hidden rounded-lg">
        <a href="https://github.com/CoduUday/Web-Projects/tree/main/Netflix%20Clone">
            <img
                className="h-[200px] object-center rounded-lg transition-transform duration-300 hover:scale-110"
                src={netflix}
            />
        </a>
    </div>
